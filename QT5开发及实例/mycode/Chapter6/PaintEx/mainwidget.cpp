    ...
    : QWidget(parent)
{
    ...
    void (QComboBox::*ShowShapeSingal)(int) = &QComboBox::activated;
    connect(shapeComboBox, ShowShapeSingal, this, ShowShape);
    ...
    connect(penColorBtn, &QPushButton::clicked, this, ShowPenColor);

    penWidthLabel =new QLabel(tr("画笔线宽："));     	//画笔线宽选择控件
    penWidthSpinBox =new QSpinBox;
    penWidthSpinBox->setRange(0,20);
    void (QSpinBox::*ShowPenWidthSingal)(int) = &QSpinBox::valueChanged;
    connect(penWidthSpinBox, ShowPenWidthSingal, this, ShowPenWidth);
    ...
    void (QComboBox::*ShowPenStyleSingal)(int) = &QComboBox::activated;
    connect(penStyleComboBox, ShowPenStyleSingal, this, ShowPenStyle);

    ...
    : QDialog(parent)
{
    ...
    mainLayout->addWidget(geoValuelLabel, 4, 1);
...
void Geometry::updateLabel()
{
    ...
    rectStr = tempStr31.setNum(rect().x()) + "," +
            ...
            tempStr33.setNum(width()) + "," +
            tempStr34.setNum(height());
...
{
    // 响应对话框的大小调整事件，在窗体大小发生改变时，同步更新显示结果
    updateLabel();
}

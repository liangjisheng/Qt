    ...
    :QDialog(parent)
{
    ...
    connect(questionBtn, &QPushButton::clicked, this, showQuestionMsg);
    connect(informationBtn, &QPushButton::clicked, this, showInformationMsg);
    connect(warningBtn, &QPushButton::clicked, this, showWarningMsg);
    connect(criticalBtn, &QPushButton::clicked, this, showCriticalMsg);
    connect(aboutBtn, &QPushButton::clicked, this, showAboutMsg);
    connect(aboutQtBtn, &QPushButton::clicked, this, showAboutQtMsg);
}
